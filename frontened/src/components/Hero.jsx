...
// import gradiendBackground from '../assets/assets.js'
...
<div className='flex flex-wrap justify-center gap-4 text-sm max-sm:text-xs'>
    <button onClick={()=> navigate('/ai')} className='bg-primary text-white px-10 py-3 rounded-lg hover:scale-102 active:scale-102 active-scale-95 transitiommcursor-pointer' >Start creating now</button>
     <button className='bg-white px-10 py-3 rounded-lg border border-gray-300 hover:scale-102 active:scale-95 tarnsition cursor-pointer'>Watch demo</button>
</div>

<div className='flex  gap-4 mt-8 mx:auto text-gray-600 justify-center'>
